...
*/
  ...
  ngOnInit(): void {
    ...
    // this.filteredList = this.list;
      ...
      (document.getElementById('Region1') as any).value = this.dataService.Region;
      (document.getElementById('PipelineDiameter1') as any).value = this.dataService.PipelineDiameter;
      (document.getElementById('LengthField1') as any).value = this.dataService.LengthField;
      (document.getElementById('GroundFloor1') as any).value = this.dataService.GroundFloor;
      (document.getElementById('FinalFloor1') as any).value = this.dataService.FinalFloor;
      (document.getElementById('FloorHeight1') as any).value = this.dataService.FloorHeight;
      (document.getElementById('AcceptableOffsetOfTheInsetPoints1') as any).value = this.dataService.AcceptableOffsetOfTheInsetPoints;
            ...
            if (this.dataService.lower_extension < 15) {
              if (this.dataService.num_calcs > 0) {
                for (var i = 0; i < this.dataService.num_calcs; i++) {
                  ...
                  if (i == 0) {
                    this.dataService.Region = this.dataService.idx[i];
                    this.dataService.PipelineDiameter = this.dataService.dn;
                    this.dataService.LengthField = this.dataService.Length[i];
                    this.dataService.GroundFloor = this.dataService.Start_floor[i];
                    this.dataService.FinalFloor = this.dataService.End_floor[i];
                    this.dataService.FloorHeight = this.dataService.Floor_height[i];
                    this.dataService.AcceptableOffsetOfTheInsetPoints = this.dataService.Shift[i];
                  }
                  if (i == 1) {
